...
<form id="JudgeEval" name="JudgeEval" method="POST" action="confirm.php">
	...
	A. Technical Accuracy
		<input type="radio" name="TA" value="5"> 5
	...
	B. Creativity and Innovation
		<input type="radio" name="CI" value="5"> 5
	...
	C. Supporting Analytical Work
		<input type="radio" name="SAW" value="5"> 5
	...
	D. Methodical Design Process Demonstrated
		<input type="radio" name="MDPD" value="5"> 5
	...
	E. Addresses Project Complexity Appropriately
		<input type="radio" name="APCA" value="5"> 5
	...
	F. Expectation of Completion (by term's end)
		<input type="radio" name="EC" value="5"> 5
	...
	G. Design and Analysis of tests
		<input type="radio" name="DA" value="5"> 5
	...
	<br>
	A. Organization
		<input type="radio" name="O" value="5"> 5
	...
	B. Use of Alloted Time
		<input type="radio" name="UAT" value="5"> 5
	...
	<br>
	C. Visual Aids
		<input type="radio" name="VA" value="5"> 5
	...
	D. Confidence and Poise
		<input type="radio" name="CP" value="5"> 5
